...
if __name__ == '__main__':
    ...
    # doc_seg = thunlp_model.cut(doc)
    # for seg, seg_type in doc_seg:
    ...
    indentify_pattern = re.compile(u'.{2}〔\d+〕\d+号')
    for str in re.findall(pattern, doc):
        print str
    for str in re.findall(indentify_pattern, doc):
        print str